...
icmp6ndoptscls = {1: "ICMPv6NDOptSrcLLAddr",
                  ...
                  26: "ICMPv6NDOptEFA",
                  31: "ICMPv6NDOptDNSSL",
                  251: "ICMPv6NDOptDADHSEC",
                  252: "ICMPv6NDOptDADH",
                  253: "ICMPv6NDOptDADmatch",
                  254: "ICMPv6NDOptTrustND"
                  }
...
class DADmatch(Field):
    def __init__(self, name, default):
        Field.__init__(self, name, default, "16s")


class ICMPv6NDOptDADmatch(_ICMPv6NDGuessPayload, Packet):  # Ahmed
    name = "DAD match"
    fields_desc = [ByteField("type", 253),
                   ByteField("len", 3),
                   XShortField("nonce", 0),
                   IntField("ide", 999999),
                   DADmatch("DADmatch", "")]
...
class EnHash(Field):
    def __init__(self, name, default):
        Field.__init__(self, name, default, "256s")
...
class ICMPv6NDOptDADHSEC(_ICMPv6NDGuessPayload, Packet):  # Ahmed
    name = "DAD HSEC"
    fields_desc = [ByteField("type", 251),
                   ByteField("len", 65),
                   XShortField("res", 0),
                   IntField("res2", 0),
                   EnHash("EnHash", ""),
...
class TrustND(Field):
    def __init__(self, name, default):
        Field.__init__(self, name, default, "20s")


class ICMPv6NDOptTrustND(_ICMPv6NDGuessPayload, Packet):  # Ahmed
    name = "Trust ND"
    fields_desc = [ByteField("type", 254),
                   ByteField("len", 4),
                   XShortField("res", 0),
...
class ICMPv6NDOptDADH(_ICMPv6NDGuessPayload, Packet):  # Ahmed
    name = "Trust ND"
    fields_desc = [ByteField("type", 252),
                   ByteField("len", 2),
                   XShortField("res1", 0),
                   XIntField("res2", 0x00000000),
                   DADH("hash", "")]
...
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class ICMPv6ND_NS_E(_ICMPv6NDGuessPayload, _ICMPv6, Packet):
    name = "ICMPv6 Neighbor Discovery - Neighbor Solicitation"
...
class ICMPv6ND_NA_E(_ICMPv6NDGuessPayload, _ICMPv6, Packet):
    name = "ICMPv6 Neighbor Discovery - Neighbor Advertisement"
    ...
    # class DADmatch(Field):
    #     def __init__(self, name, default):
    #         Field.__init__(self, name, default, "64s")

    # class ICMPv6ND_DAD(_ICMPv6NDGuessPayload, _ICMPv6, Packet):
    #     name = "ICMPv6 Neighbor Discovery - Ahmed"
    #     fields_desc = [ ByteEnumField("type",201, icmp6types),
    #                     ByteField("code",0),
    #                     XShortField("cksum", None),
    #                     BitField("R",1,1),
    ...
    def answers(self, other):
        return isinstance(other, ICMPv6ND_DAD) and self.tgt == other.tgt
...
class TracerouteResult6(TracerouteResult):
    ...
    def show(self):
        return self.make_table(lambda s_r: (
        s_r[0].sprintf("%-42s,IPv6.dst%:{TCP:tcp%TCP.dport%}{UDP:udp%UDP.dport%}{ICMPv6EchoRequest:IER}"),
        # TODO: ICMPv6 !
        s_r[0].hlim,
